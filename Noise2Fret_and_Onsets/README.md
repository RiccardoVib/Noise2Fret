...
| Model               | # Params | FLOPs |
|---------------------|---------|-------|
| Noise2Fret          | 26 M | 643 M |
| TabCNN+Conformer [1] | 8.4 M | 1.8 M |
| FretNet [2]         | 8.4 M | 403 M |
...
[1] K. Sehun, H. Tomoki, and T. Tomoki, “Note-level automatic guitar transcription using attention mechanism,” in EUSIPCO, 2022, pp. 229–233.
